...
<title>北見デンタルクリニック | ACCESS</title>
<link href="<?php bloginfo('stylesheet_url'); ?>" rel="stylesheet" type="text/css" media="screen">
<link href="<?php bloginfo('template_url'); ?>/css/access.css" rel="stylesheet" type="text/css" media="all">
...
<div class="contentsback">
  <div class="container">
    <div class="contents">
      <div class="acesWap">
  		<h2><img src="<?php bloginfo('template_url'); ?>/images/access/mvImage.jpg" width="820" height="180" alt="アクセスイメージ"></h2>
        <h3 class="acesTitle"><img src="<?php bloginfo('template_url'); ?>/images/access/title04_aces.gif" width="160" height="38" alt="アクセスタイトル"></h3>
        <div class="aiWap">
          <p class="mContent"><img src="<?php bloginfo('template_url'); ?>/images/access/access.gif" width="530" height="450" alt="アクセスイメージ"></p>
          <div class="acesText">
            <p>住所</p>
            <p class="dtl">〒530-0034<br>
            大阪府大阪市北区錦町4-33</p>
            <p class="dtl">JR天満駅の出入口2番を出て徒歩5分</p>
            <p class="dtTitle">Tel</p>
            <p class="dtl">06-639-8149</p>
            <p class="dtTitle">Fax</p>
            <p class="dtl">09-639-8148</p>
          </div>
        </div>
      </div>
    </div>
