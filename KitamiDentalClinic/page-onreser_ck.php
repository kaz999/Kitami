...
<link href="<?php bloginfo('template_url'); ?>" rel="stylesheet" type="text/css" media="screen">
    ...
    <div class="contents">
      <div class="inqWap">
        ...
        <div class="itWap">
          ...
          <ul>
              <li><a href="#"><img src="<?php bloginfo('template_url'); ?>/images/inquiry/back.gif" width="135" height="40" alt="戻る"></a></li>
           	  <li class="send"><input name="send" type="image" id="send" src="<?php bloginfo('template_url'); ?>/images/inquiry/send.gif" alt="送信"></li>
          </ul>
		  </form>
        </div>
      </div>
