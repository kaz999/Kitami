...
<link href="<?php bloginfo('template_url'); ?>/css/sitemap.css" rel="stylesheet" type="text/css" media="all">
...
<div class="contentsback">
  <div class="container">
    <div class="contents">
      <div class="siteWap">
        <h2><img src="<?php bloginfo('template_url'); ?>/images/sitemap/mvImage.jpg" width="820" height="180" alt="サイトマップイメージ"></h2>
        <h3 class="siteTItle"><img src="<?php bloginfo('template_url'); ?>/images/sitemap/title.gif" width="214" height="38" alt="サイトマップタイトル"></h3>
        <div class="stWap">
          <section>
            <p class="home"><a href="<?php echo home_url('/'); ?>">ホーム<span>Home</span></a></p>
            <p class="dTitle">歯科案内<span>Dental Information</span></p>
            <p class="dentc"><a href="<?php echo get_page_link(9); ?>">一般歯科<span>General dentistry</span></a></p>
            <p class="dentc"><a href="<?php echo get_page_link(11); ?>">矯正歯科<span>Orthodontics</span></a></p>
            <p class="dentcBm"><a href="<?php echo get_page_link(13); ?>">インプラント<span></span>Implant</a></p>
            <p><a href="<?php echo get_page_link(15); ?>">ドクター紹介<span>Introduction of the doctor</span></a></p>
            <p><a href="<?php echo get_page_link(17); ?>">アクセス<span>Access</span></a></p>
            <p><a href="<?php echo get_page_link(19); ?>">スタッフブログ<span>Staff blog</span></a></p>
            <p><a href="<?php echo get_page_link(23); ?>">オンライン予約<span>Online reservations</span></a></p>
            <p><a href="<?php echo get_page_link(21); ?>">お問い合わせ<span>Inquiry</span></a></p>
            <p><a href="<?php echo get_page_link(25); ?>">求人情報<span>Job Information</span></a></p>
            <p class="btm"><a href="<?php echo get_page_link(27); ?>">サイトマップ<span>Sitemap</span></a></p>
          </section>
        </div>
      </div>
    </div>
